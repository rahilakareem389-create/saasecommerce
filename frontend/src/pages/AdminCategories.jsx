...
export default function AdminCategories() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        await axios.put(`https://saasecommerce.vercel.app/api/categories/${editId}`, categoryData, config);
      } else {
        await axios.post('https://saasecommerce.vercel.app/api/categories', categoryData, config);
      }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const config = { headers: { Authorization: `Bearer ${user.token}` } };
      await axios.delete(`https://saasecommerce.vercel.app/api/categories/${id}`, config);
      fetchCategories();
    } catch (err) {
